...
import PerspectivesCard from "@/entities/PerspectivesCard.vue";
import {perspectivesCards} from "@/shared/const/perspectivesCards";
</script>
    ...
    <div class="container">
      <div class="perspectives">
        <div class="perspectives__content">
          <h2 class="perspectives__title">Какие перспективы?</h2>
          <div class="perspectives__hh-wrapper">
            <div class="perspectives__hh">
        ...
        <div class="perspectives__card-wrapper">
          <PerspectivesCard class="perspectives__card" v-for="(card, index) in perspectivesCards"
                              :key="index"
                              :name="card.name"
                              :period="card.period"

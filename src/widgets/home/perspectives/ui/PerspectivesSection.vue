...
import PerspectivesCard from "../../../../entities/perspectives/ui/PerspectivesCard.vue";
import {GRADES} from "@/entities/grade/const/GRADES";
</script>
    ...
    <div class="container">
      <div class="perspectives">
        ...
        <div class="perspectives__card-wrapper">
          <PerspectivesCard class="perspectives__card" v-for="(card, index) in GRADES"
                              :key="index"
                              :name="card.name"
                              :period="card.period"

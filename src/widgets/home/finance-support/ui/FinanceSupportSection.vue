<script setup>
import {FINANCE_SUPPORT_CARDS, FinanceSupportCard} from "@/entities/finance-support/index.ts";
</script>

<template>
  <section class="finance-support-section">
    <div class="container">
...
.card:last-child :deep(.card__info-description) {
  @include desktop {
    width: 407px;
  }
}
